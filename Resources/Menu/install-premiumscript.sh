#!/bin/bash
# Created by http://t.me/LUFFYxSENPAI
# Script by MUGIWARA-VPN
...
cd /usr/local/bin
wget -O premium-script.tar.gz "https://raw.githubusercontent.com/89870must73/DEB/main/Resources/Menu/premium-script.tar.gz"
